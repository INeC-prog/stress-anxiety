...
while my_timer > 0:
    ...
    class Prey:
        ...
        def draw(self):
            self.parent_screen.fill((154, 154, 154))
            self.parent_screen.blit(self.block, (self.x, self.y))
    ...
    class Game:
        ...
        def display_score(self):
            ...
            line1 = font.render(f"Grid-hits:  escape {self.prey.escape-2}", True, (255, 255, 100))
        ...
        def show_test_over(self):
            ...
            line2 = font.render(f"Press Escape to exit", True, (255, 255, 100))
