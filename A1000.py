...
while my_timer > 0:
    ...
    class Game:
        ...
        def play(self):
            ...
            if is_collision(self.predator.x, self.predator.y, self.prey.x, self.prey.y):
                sound = pygame.mixer.Sound("Resources/Bell.wav")
            ...
            for i in range(18, self.predator.count):
                if is_collision(self.predator.x[i], self.predator.y[i], self.predator.x, self.predator.y):
        ...
        def run(self):
            ...
            while running:
                ...
                with open('data_A1000.txt', 'w') as f:
